...
__all__ = [
    'eWORDTYPE_DELETED', 'DISPID_SGRsFindRule',
    'DISPID_SpeechXMLRecoResult', 'SpLexicon', 'SVESentenceBoundary',
    'SGPronounciation', 'SVP_2', 'ISpeechPhraseInfoBuilder', 'SVP_12',
    'DISPID_SRCCreateGrammar', 'SPEVENTENUM', 'SPCS_DISABLED',
    'eLEXTYPE_RESERVED7', 'SLTApp',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_PRIVATE16', 'ISpStreamFormatConverter',
    'SAFT44kHz8BitMono', 'SVPOver', 'DISPID_SpeechGrammarRules',
    'ISpeechPhraseInfo', 'SPRST_ACTIVE', 'eLEXTYPE_APP',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRCEPropertyStringChange',
    'SVEAudioLevel', 'DISPID_SWFEExtraData', 'SPSEMANTICFORMAT',
    'SAFTText', 'SPEI_RESERVED2', 'SpeechPartOfSpeech', 'SP_VISEME_1',
    'DISPID_SPIElements', 'SREStreamEnd', 'SPEI_END_SR_STREAM',
    'SGLexical', 'SPSNoun', 'SPSVerb', 'DISPID_SVEEnginePrivate',
    'SAFT24kHz16BitStereo', 'DISPID_SBSSeek', 'SPRS_ACTIVE',
    'SPRST_NUM_STATES', 'SPPS_Interjection', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCEBookmark', 'SVP_1', 'SVP_10', 'ISpPhoneConverter',
    'DISPID_SGRs_NewEnum', 'DISPID_SpeechPhraseProperty',
    'SPFM_CREATE_ALWAYS', 'SpPhoneticAlphabetConverter',
    'ISpStreamFormat', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRRAudio', 'DISPID_SPIAudioSizeBytes',
    'SpeechGrammarTagDictation', 'SASClosed', 'SDTAll',
    'DISPID_SVSLastStreamNumberQueued', 'SPSERIALIZEDRESULT',
    'SpNotifyTranslator', 'SPSERIALIZEDPHRASE',
    'ISpeechGrammarRuleStateTransition', 'ISpeechAudio',
    'SP_VISEME_8', 'SPEI_RECO_STATE_CHANGE', 'SDTAudio',
    'DISPID_SpeechAudioStatus', 'DISPID_SPAStartElementInResult',
    'SPEI_VISEME', 'DISPID_SRSAudioStatus', 'SWTAdded',
    'DISPID_SLPSymbolic', 'SpeechPropertyNormalConfidenceThreshold',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVSFNLPMask',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVSLastBookmark',
    'DISPID_SRCERequestUI', 'DISPID_SPEAudioSizeBytes',
    'SpeechTokenKeyUI', 'DISPID_SPEsCount',
    'DISPID_SOTCreateInstance', 'SRAExport', 'SFTSREngine',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRRSpeakAudio',
    'DISPID_SPERetainedSizeBytes', 'SP_VISEME_17',
    'DISPID_SPISaveToMemory', 'SAFTADPCM_11kHzStereo',
    'SpeechGrammarState', 'ISpRecoCategory', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVSLastResult', 'ISpeechPhraseRules', 'SPBOOKMARKOPTIONS',
    'DISPID_SLPType', 'SPAR_Medium', 'DISPID_SpeechLexiconWord',
    'ISpeechWaveFormatEx', 'eLEXTYPE_PRIVATE19', 'ISpeechLexicon',
    'SPRST_INACTIVE', 'SPFM_OPEN_READONLY', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFTADPCM_44kHzMono', 'eLEXTYPE_PRIVATE4', 'SP_VISEME_20',
    'SDTReplacement', 'DISPID_SPRuleFirstElement',
    'DISPID_SPILanguageId', 'DISPID_SPEPronunciation',
    'SAFT32kHz8BitStereo', 'SpInprocRecognizer',
    'SpeechCategoryRecoProfiles', 'SpInProcRecoContext',
    'DISPID_SOTGetDescription', 'DISPID_SPERetainedStreamOffset',
    'ISpeechFileStream', 'DISPID_SOTCSetId', 'SVP_20',
    'DISPID_SABufferInfo', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPRsCount', 'SPVPRI_OVER', 'SAFTADPCM_22kHzStereo',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPARecoResult',
    'ISpStream', 'ISpObjectTokenCategory', 'SP_VISEME_19',
    'DISPID_SRDisplayUI', 'DISPID_SPPs_NewEnum', 'SP_VISEME_15',
    'SPXRO_SML', 'SpeechAllElements',
    ...
    'SPWT_DISPLAY', 'SVEViseme', 'ISpXMLRecoResult',
    'DISPID_SpeechObjectTokens', 'SDTLexicalForm',
    'STSF_CommonAppData', 'DISPID_SPIProperties',
    'eLEXTYPE_PRIVATE10', 'SPEI_RESERVED3',
    'SpeechAudioFormatGUIDWave', 'DISPID_SVSpeakStream',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechAudio', 'DISPID_SRAudioInput', 'ISpVoice',
    'DISPID_SLPsCount', 'DISPID_SRGRecoContext', 'STCRemoteServer',
    'DISPID_SPRuleId', 'DISPID_SWFEBlockAlign', 'SECFDefault',
    'DISPID_SBSRead', 'SpeechPropertyComplexResponseSpeed',
    'SWPKnownWordPronounceable', 'DISPID_SGRsItem', 'SREStreamStart',
    'SpCompressedLexicon', 'DISPID_SpeechRecoResult2',
    'DISPID_SOTIsUISupported', 'SGSEnabled', 'SPINTERFERENCE_NONE',
    'DISPID_SGRSTPropertyName', 'DISPID_SGRSTRule',
    'eLEXTYPE_RESERVED9', 'ISpeechVoice',
    'SDA_Consume_Leading_Spaces', 'SPTEXTSELECTIONINFO',
    'SAFTCCITT_ALaw_8kHzStereo', 'SREAudioLevel', 'DISPID_SGRsCommit',
    'DISPID_SPPValue', 'DISPID_SpeechPhraseInfo', 'SGRSTTWord',
    'SAFT32kHz16BitMono', 'SECHighConfidence', 'SpeechAudioState',
    'SPDKL_DefaultLocation', 'DISPID_SPRuleChildren',
    'ISpeechLexiconPronunciations', 'SpMMAudioEnum', 'SRTEmulated',
    'SpAudioFormat', 'SP_VISEME_4', 'SPCONTEXTSTATE', 'SVP_9',
    'DISPID_SOTSetId', 'DISPID_SVResume', 'ISpeechPhraseElement',
    'SPPARTOFSPEECH', 'SPEI_REQUEST_UI', 'SPXMLRESULTOPTIONS',
    'DISPID_SpeechBaseStream', 'DISPID_SVStatus',
    'DISPID_SPRulesCount', 'DISPID_SOTCId', 'SVSFPersistXML',
    'DISPID_SRCEAdaptation', 'SPEVENTSOURCEINFO',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRRGetXMLResult', 'SPAS_CLOSED', 'SpStream',
    'DISPID_SASState', 'DISPID_SVPriority', 'DISPID_SRRTTickCount',
    'SpeechRecoEvents', 'DISPID_SpeechFileStream', 'SVP_17',
    'SPAR_High', 'ISpObjectWithToken', 'DISPID_SWFEBitsPerSample',
    'DISPID_SRSCurrentStreamNumber', 'SP_VISEME_12',
    'DISPID_SWFEFormatTag', 'SPRULESTATE', 'SpeechWordType',
    'DISPID_SRCreateRecoContext', 'SAFT12kHz8BitMono',
    'eLEXTYPE_PRIVATE2', 'SGRSTTDictation', 'DISPID_SPEAudioSizeTime',
    'SSFMOpenForRead',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVP_14',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechLexiconType',
    'DISPID_SDKEnumValues', 'DISPID_SpeechPhraseAlternates',
    'eLEXTYPE_PRIVATE18', 'SAFT11kHz8BitStereo',
    'SAFTGSM610_11kHzMono', 'SRSInactiveWithPurge', 'SPAUDIOSTATE',
    'SPSHT_NotOverriden', 'SPEI_VOICE_CHANGE', 'SpeechVoicePriority',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE3',
    'SpeechTokenShellFolder', 'SREAllEvents',
    'DISPID_SPANumberOfElementsInResult', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SVPause', 'SECFNoSpecialChars', 'DISPID_SOTsCount',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRRRecoContext',
    'DISPID_SVSRunningState', 'SAFTADPCM_11kHzMono',
    'DISPID_SOTMatchesAttributes', 'SVSFDefault', 'SP_VISEME_14',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SpeechGrammarRuleStateTransition', 'SRERequestUI',
    'Library', 'DISPID_SPPId', 'ISpDataKey',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRGetRecognizers',
    'DISPID_SRIsShared', 'SpeechInterference', 'DISPID_SVDisplayUI',
    'SPRECOCONTEXTSTATUS', 'SPAR_Unknown', 'SPEI_PHRASE_START',
    'ISpEventSink', 'SWTDeleted', 'ISpeechRecoResult2', 'SLTUser',
    'DISPID_SPRuleName', 'SVF_Emphasis',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVVoice',
    'DISPIDSPTSI_ActiveOffset', 'ISpProperties', 'SRSInactive',
    'SPEI_PROPERTY_STRING_CHANGE', 'eLEXTYPE_RESERVED8',
    'DISPID_SPRDisplayAttributes', 'ISpeechPhraseElements',
    'SECLowConfidence', 'DISPID_SCSBaseStream', 'SPSHT_Unknown',
    'DISPID_SRCRetainedAudioFormat', 'ISpeechPhraseRule',
    'DISPID_SVESentenceBoundary', 'SpeechLoadOption',
    'DISPID_SPERequiredConfidence', 'SPVPRI_NORMAL',
    'STSF_LocalAppData', 'DISPID_SPRuleNumberOfElements',
    'ISpSerializeState', 'SREBookmark',
    'DISPID_SPRuleEngineConfidence', 'SGRSTTRule',
    'SPWT_PRONUNCIATION', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SpeechAudioFormat', 'SPGS_EXCLUSIVE', 'DISPID_SPPsCount',
    'SVEVoiceChange', 'SVEPrivate', 'DISPID_SVEAudioLevel',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechObjectTokenCategory',
    'Speech_StreamPos_RealTime', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SINoise', 'SAFT16kHz16BitMono', 'SpeechBookmarkOptions',
    'SDKLLocalMachine', 'DISPID_SAStatus', 'eLEXTYPE_LETTERTOSOUND',
    'SPWORD', '_ISpeechVoiceEvents', 'SECFEmulateResult',
    'eLEXTYPE_PRIVATE20', 'SPEI_SOUND_END',
    'IInternetSecurityManager', 'SpeechVisemeFeature',
    'DISPID_SpeechPhraseBuilder', 'eLEXTYPE_RESERVED6',
    'ISpeechPhraseProperties', 'SVP_6', '_RemotableHandle',
    'eLEXTYPE_PRIVATE17', 'SpeechVisemeType',
    'DISPID_SRCERecognition', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SGRSTType', 'ISpeechLexiconWord', 'SPEI_MIN_SR',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTADPCM_8kHzMono',
    'SpeechGrammarTagWildcard', 'SDTRule', 'DISPID_SVEStreamEnd',
    ...
    'SREPrivate', 'DISPID_SRCEEnginePrivate', 'SINone',
    'DISPID_SPRs_NewEnum', 'SAFTNoAssignedFormat', 'SECFIgnoreCase',
    'SPCATEGORYTYPE', 'DISPID_SPEDisplayAttributes',
    'ISpNotifySource', 'IEnumString', 'SVPAlert', 'SDTDisplayText',
    'DISPID_SRGRules', 'DISPID_SGRSRule', 'DISPID_SRCEventInterests',
    'DISPID_SRRAlternates', 'DISPID_SMSSetData',
    'DISPID_SLWs_NewEnum', 'DISPID_SLPPartOfSpeech',
    'DISPID_SOTRemove', 'DISPID_SRSSupportedLanguages',
    'DISPID_SBSWrite', 'WAVEFORMATEX', 'SpeechRecoProfileProperties',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRCERecognizerStateChange',
    'ISpPhrase', 'SAFTCCITT_uLaw_11kHzMono', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPEDisplayText', 'SSSPTRelativeToStart',
    'DISPID_SLRemovePronunciation', 'SAFT16kHz8BitStereo',
    'SPSFunction', 'SFTInput', 'SRAONone', 'SITooQuiet',
    'DISPID_SRCRequestedUIType', 'SGLexicalNoSpecialChars',
    'SVEStartInputStream', 'SPPS_RESERVED3', 'ISpeechResourceLoader',
    'SPSMF_SAPI_PROPERTIES', 'SLODynamic', 'SAFT22kHz16BitMono',
    'SP_VISEME_21', 'SVF_None', 'SDA_Two_Trailing_Spaces',
    'DISPID_SOTGetAttribute', 'DISPID_SPIGrammarId', 'DISPID_SOTId',
    'DISPID_SVSVisemeId', 'SDA_No_Trailing_Space',
    'SpeechTokenIdUserLexicon', 'DISPID_SGRsCommitAndSave',
    'SPPHRASEELEMENT', 'DISPID_SOTDataKey',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPRsItem',
    'SpeechAudioFormatType', 'SAFT48kHz16BitStereo',
    'SpeechGrammarWordType', 'ISpeechLexiconWords', 'SVP_8',
    'DISPID_SRRTStreamTime', 'DISPID_SVWaitUntilDone',
    'DISPID_SRCERecognitionForOtherContext', 'SPINTERFERENCE_TOOFAST',
    'eLEXTYPE_PRIVATE7', 'SVSFIsFilename', 'DISPID_SPRuleParent',
    'SPEI_RECOGNITION', 'SPDKL_LocalMachine', 'SPRECOGNIZERSTATUS',
    'SRAImport', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechPhraseAlternate', 'SAFT48kHz8BitStereo',
    'SpeechRuleState', 'SPLEXICONTYPE', 'DISPID_SADefaultFormat',
    'SPEI_TTS_BOOKMARK', 'SPBO_NONE', 'DISPID_SRAudioInputStream',
    'SAFT48kHz16BitMono', 'SVSFIsXML', 'SpResourceManager',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SLPLangId', 'SRSActiveAlways',
    'SPFM_NUM_MODES', 'SAFT24kHz16BitMono', 'SVSFlagsAsync',
    'SpeechPropertyAdaptationOn', 'SPDKL_CurrentConfig',
    'SPCT_COMMAND', 'DISPID_SFSOpen', 'DISPID_SPEEngineConfidence',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVP_3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SGRSTs_NewEnum',
    'eLEXTYPE_PRIVATE15', 'SPXRO_Alternates_SML', 'DISPID_SRCPause',
    'SVEEndInputStream', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpMMAudioIn',
    'SAFT44kHz16BitMono', 'SPEI_ADAPTATION', 'DISPID_SGRClear',
    'SPCT_SUB_DICTATION', 'DISPID_SGRAttributes',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCState',
    'ISpRecoGrammar2', 'DISPID_SPRFirstElement', 'ISpRecoResult',
    'DISPID_SpeechPhraseElements', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPELexicalForm', 'SAFT16kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPName',
    'ISpeechAudioFormat', 'SAFTCCITT_uLaw_44kHzMono',
    'SPINTERFERENCE', 'DISPID_SRProfile', 'DISPID_SLPs_NewEnum',
    'SPEI_FALSE_RECOGNITION', 'SAFTADPCM_8kHzStereo',
    'eWORDTYPE_ADDED', 'SPAUDIOBUFFERINFO', 'SPDATAKEYLOCATION',
    'DISPID_SLGetGenerationChange',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpeechVoiceSpeakFlags',
    'SPINTERFERENCE_NOSIGNAL', 'SP_VISEME_6',
    'DISPID_SpeechGrammarRule', 'DISPID_SRCResume', 'SRSActive',
    'DISPID_SDKSetStringValue', 'SPSUnknown', 'SPEI_RESERVED1',
    'SPVOICESTATUS', 'DISPID_SpeechRecoResult', 'DISPID_SRRTLength',
    'DISPID_SRGId', 'SpeechCategoryAppLexicons', 'STCInprocServer',
    'SpeechTokenKeyAttributes', 'DISPID_SPRuleConfidence',
    'DISPID_SpeechVoiceEvent', 'DISPID_SGRsDynamic',
    'SpPhraseInfoBuilder', 'SPPHRASEREPLACEMENT',
    'DISPID_SPIReplacements', 'SVSFParseMask',
    'DISPID_SpeechPhraseAlternate', 'SpeechAddRemoveWord',
    'SAFT11kHz16BitMono', 'DISPID_SRCVoice',
    'SpeechPropertyResourceUsage', 'SpeechCategoryAudioIn',
    'ISpeechRecoResultTimes', 'SGDSActiveWithAutoPause',
    'SPWORDPRONUNCIATION', 'SVSFParseSapi',
    'DISPID_SABIMinNotification', 'SPDKL_CurrentUser',
    'eLEXTYPE_RESERVED10', 'SP_VISEME_11',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SVAudioOutputStream',
    'eLEXTYPE_PRIVATE1', 'DISPID_SPPConfidence',
    'SVSFParseAutodetect', 'SPEI_SR_AUDIO_LEVEL', 'DISPIDSPRG',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRGDictationLoad',
    'DISPID_SPACommit', '_ISpeechRecoContextEvents',
    'DISPID_SGRAddState', 'DISPID_SpeechRecognizer',
    'DISPID_SRGState', 'DISPID_SPPBRestorePhraseFromMemory',
    'SECNormalConfidence', 'DISPID_SLAddPronunciation',
    'SPFM_OPEN_READWRITE', 'DISPID_SREmulateRecognition',
    'DISPID_SRGSetWordSequenceData', 'SREInterference',
    'DISPID_SVGetVoices', 'DISPID_SRGetPropertyString',
    'DISPID_SGRAddResource', 'DISPID_SOTCDefault',
    'DISPID_SpeechCustomStream', 'SRADynamic', 'DISPID_SOTs_NewEnum',
    'DISPID_SPRNumberOfElements', 'SPWORDPRONOUNCEABLE',
    'DISPID_SVSpeak', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SPPsItem',
    'SGSDisabled', 'DISPID_SWFEAvgBytesPerSec',
    'SGDSActiveUserDelimited', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SRESoundEnd',
    'DISPID_SPAsItem', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechRecoContextState', 'DISPID_SVEStreamStart',
    'ISpeechRecoGrammar', 'DISPID_SPCLangId', 'SPINTERFERENCE_NOISE',
    'SPVISEMES', 'DISPID_SDKCreateKey', 'ISpeechAudioStatus',
    'SP_VISEME_9', 'ISpPhoneticAlphabetSelection',
    'DISPID_SABIBufferSize', 'SREHypothesis', 'eLEXTYPE_PRIVATE11',
    'SAFT48kHz8BitMono', 'DISPID_SRCEInterference',
    'ISpeechRecognizer', 'DISPID_SOTGetStorageFileName',
    ...
    'DISPID_SGRSTsCount', 'SAFTTrueSpeech_8kHz1BitMono', 'SPEVENT',
    'DISPIDSPTSI', 'SRATopLevel', 'DISPIDSPTSI_SelectionOffset',
    'SDTAlternates', 'DISPID_SLWLangId', 'SVP_19',
    'ISpeechPhraseReplacement', 'DISPID_SPEAudioTimeOffset',
    'ISpRecognizer', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SAVolume', 'SpeechVoiceEvents', 'ISpeechVoiceStatus',
    'SPAO_RETAIN_AUDIO', 'DISPID_SPCPhoneToId', 'SVF_Stressed',
    'SVEBookmark', 'SREPhraseStart',
    'SpeechPropertyLowConfidenceThreshold', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechVoiceStatus', 'SP_VISEME_16', 'SPEI_INTERFERENCE',
    'SVSFNLPSpeakPunc', 'SGRSTTEpsilon', 'SGDSInactive',
    'DISPID_SRCBookmark', 'ISpeechPhraseProperty',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SITooSlow',
    'STCLocalServer', 'ISpPhoneticAlphabetConverter',
    'SVSFUnusedFlags', 'DISPID_SPCIdToPhone', 'ISpeechGrammarRules',
    'ISpRecognizer3', 'ISpeechRecoContext', 'SpMMAudioOut',
    'SPINTERFERENCE_TOOQUIET', 'SDKLCurrentUser', 'SPAUDIOSTATUS',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SASCurrentSeekPosition',
    'SPAS_RUN', 'SPCT_SLEEP', 'SREPropertyNumChange', 'SVPNormal',
    'SpeechRetainedAudioOptions', 'SpeechUserTraining',
    'DISPID_SRGSetTextSelection', 'DISPID_SRCESoundEnd',
    'SpeechAudioVolume', 'DISPID_SWFESamplesPerSec',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPRECORESULTTIMES',
    'DISPID_SPPChildren', 'SPWF_SRENGINE', 'SVP_21',
    'ISpResourceManager', 'SSTTDictation',
    'DISPID_SOTRemoveStorageFileName', 'SPSEMANTICERRORINFO',
    'SpeechRegistryUserRoot', 'SAFTDefault', 'SREAdaptation',
    'SREStateChange', 'SDTPronunciation',
    'DISPID_SVSpeakCompleteEvent', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRRecognizer', 'DISPID_SRSClsidEngine',
    'DISPID_SBSFormat', 'DISPID_SRCEHypothesis',
    'DISPID_SRGDictationUnload', 'DISPID_SpeechGrammarRuleState',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpeechAudioBufferInfo',
    'SRADefaultToActive',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpObjectTokenCategory', 'DISPID_SLWsItem', 'SPVPRIORITY',
    'ISpeechLexiconPronunciation', 'DISPID_SVSInputWordPosition',
    'SPLO_STATIC', 'DISPID_SpeechPhraseReplacements', 'SRSEDone',
    'SINoSignal', 'SVP_7', 'DISPID_SVSLastBookmarkId',
    'ISpNotifySink', 'SP_VISEME_0', 'ISpRecoContext', 'LONG_PTR',
    'DISPID_SRGCommit', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SASetState', 'ISpeechRecoResult',
    'DISPID_SPPNumberOfElements', 'DISPID_SLWsCount',
    'DISPID_SPRules_NewEnum', 'DISPID_SOTDisplayUI',
    'DISPID_SVSInputWordLength', 'eLEXTYPE_PRIVATE12',
    'STCInprocHandler', 'DISPID_SRCSetAdaptationData',
    'DISPID_SGRsAdd', 'SpShortcut', 'SWPUnknownWordUnpronounceable',
    'ISpeechMMSysAudio', 'DISPID_SpeechRecoContext',
    'DISPID_SDKEnumKeys', 'SpNullPhoneConverter', 'SPEI_UNDEFINED',
    'SPEI_SR_PRIVATE', 'DISPID_SMSGetData', 'SAFT11kHz16BitStereo',
    'Speech_Max_Word_Length', 'eLEXTYPE_PRIVATE8',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SASNonBlockingIO',
    'SPBO_AHEAD', 'DISPID_SRStatus', 'SECFIgnoreWidth',
    'SPEI_MIN_TTS', 'DISPID_SGRSTWeight', 'Speech_Default_Weight',
    'SPAO_NONE', 'SP_VISEME_7', 'DISPID_SVVolume',
    'DISPID_SABufferNotifySize', 'ISpEventSource', 'DISPID_SLPsItem',
    'DISPID_SLGenerationId', 'SPWF_INPUT', 'SPSSuppressWord',
    'DISPID_SpeechPhraseRule', 'ISpeechRecognizerStatus',
    'ISpeechDataKey', 'DISPID_SPEActualConfidence',
    'SRERecoOtherContext', 'SSFMCreate', 'ISpeechRecoResultDispatch',
    'DISPID_SVRate', 'SpFileStream', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPPFirstElement', 'ISpRecognizer2',
    ...
    'SpSharedRecognizer', 'SPWORDTYPE', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechTokenKeyFiles', 'SpeechDictationTopicSpelling',
    'SpMemoryStream', 'SRTSMLTimeout', 'DISPID_SRState',
    'SPAUDIOOPTIONS', 'SpeechTokenContext', 'SPBO_TIME_UNITS',
    'SPPHRASEPROPERTY', 'SAFT24kHz8BitStereo', 'SPGS_DISABLED',
    'DISPID_SVSPhonemeId', 'DISPID_SLWWord', 'ISpNotifyTranslator',
    'SPEI_PHONEME', 'SDKLDefaultLocation', 'DISPID_SRCEEndStream',
    'SpCustomStream', 'DISPID_SMSADeviceId', 'SVP_0',
    'DISPID_SMSAMMHandle', 'SP_VISEME_13', 'SPBO_PAUSE',
    'SpeechEngineConfidence', 'SPRST_ACTIVE_ALWAYS', 'ISpObjectToken',
    'DISPID_SWFEChannels', 'SPSHT_EMAIL', 'DISPID_SPAPhraseInfo',
    'SPLO_DYNAMIC', 'DISPID_SRCRecognizer',
    'DISPID_SpeechObjectToken', 'SPEI_MAX_SR',
    ...
    'DISPID_SVGetAudioInputs', 'SRERecognition',
    ...
    'SPEI_START_INPUT_STREAM', 'SAFT32kHz16BitStereo',
    'SPEI_START_SR_STREAM', 'SAFT12kHz8BitStereo', 'SpVoice',
    'SpeechEngineProperties', 'SAFTCCITT_uLaw_11kHzStereo',
    'SP_VISEME_5', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SVGetAudioOutputs', 'SAFT16kHz8BitMono', 'SPAS_STOP',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPAsCount',
    'SAFTCCITT_ALaw_22kHzMono', 'SLOStatic', 'SVSFIsNotXML',
    'SSFMOpenReadWrite', 'SRAInterpreter', 'SpeechDiscardType',
    'SpTextSelectionInformation', 'SRSEIsSpeaking',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SpeechMemoryStream',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SASPause',
    'SPEI_RESERVED6', 'SP_VISEME_18', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SGRName', 'DISPID_SRGetPropertyNumber', 'SPPS_Function',
    'SAFTCCITT_uLaw_8kHzMono', 'SPEI_RESERVED5', 'SBONone',
    'SPRECOSTATE', 'SPGS_ENABLED', 'SVP_4', 'SAFT24kHz8BitMono',
    'SAFT8kHz16BitMono', 'ISpeechPhoneConverter',
    'DISPID_SPIStartTime', 'STSF_AppData', 'DISPID_SPPParent',
    'SpeechPropertyResponseSpeed', 'DISPID_SFSClose',
    'DISPID_SGRsCount', 'SRTStandard', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRRDiscardResultInfo', 'SDTProperty',
    'DISPID_SVAlertBoundary', 'STSF_FlagCreate', 'SPEI_MAX_TTS',
    'SRTExtendableParse', 'DISPID_SPIRetainedSizeBytes', 'SPRULE',
    'SASRun', 'SAFT12kHz16BitMono', 'SpeechCategoryPhoneConverters',
    'SVP_5', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SABIEventBias', 'DISPID_SGRSTsItem', 'SDKLCurrentConfig',
    'DISPID_SRCEStartStream', 'DISPID_SRCEPropertyNumberChange',
    'SPSLMA', 'DISPID_SOTsItem', 'DISPID_SRCCreateResultFromMemory',
    'SBOPause', 'SPCT_DICTATION', 'ISpRecoContext2',
    'DISPID_SRIsUISupported', 'DISPID_SGRSTransitions',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechCategoryAudioOut',
    'SAFTNonStandardFormat', 'DISPID_SRRPhraseInfo', 'SPPS_Unknown',
    'SPCT_SUB_COMMAND', 'SAFTGSM610_22kHzMono', 'SpeechFormatType',
    'SPSTREAMFORMATTYPE', 'DISPID_SDKDeleteValue',
    'DISPID_SpeechDataKey', 'SAFT8kHz8BitMono', '_SPAUDIOSTATE',
    'eLEXTYPE_PRIVATE9', 'DISPID_SpeechPhraseReplacement',
    'SPWT_LEXICAL', 'IInternetSecurityMgrSite',
    'DISPIDSPTSI_ActiveLength', 'eLEXTYPE_USER', 'SPFILEMODE',
    'DISPID_SpeechRecoResultTimes', 'SPEI_HYPOTHESIS',
    'DISPID_SRCESoundStart', 'SPPS_RESERVED4',
    'SSSPTRelativeToCurrentPosition', 'SVP_15', 'tagSPPROPERTYINFO',
    'SpeechAudioProperties',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT44kHz16BitStereo',
    'DISPID_SRRAudioFormat', 'eLEXTYPE_MORPHOLOGY', 'SPRS_INACTIVE',
    'DISPID_SLGetWords', 'ISpLexicon', 'ISpAudio',
    ...
    'DISPID_SRGCmdSetRuleIdState', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SVEPhoneme', 'SPAR_Low', 'SPCS_ENABLED',
    'Speech_Max_Pron_Length', 'DISPID_SDKOpenKey',
    'DISPID_SDKGetlongValue', 'SPVPRI_ALERT', 'SRTAutopause',
    'ISpPhraseAlt', 'eLEXTYPE_PRIVATE13', 'SAFT8kHz8BitStereo',
    'SPPS_Noncontent', 'SVSFParseSsml', 'SVSFVoiceMask',
    'SPPHRASERULE', 'SRAORetainAudio', 'SAFT11kHz8BitMono',
    'SGRSTTTextBuffer', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SVSInputSentencePosition', 'DISPID_SGRId',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SOTCGetDataKey', 'SPPS_Noun',
    'SAFTADPCM_44kHzStereo', 'SSSPTRelativeToEnd',
    'SAFT22kHz8BitMono', 'SpeechMicTraining', 'DISPID_SAFType',
    'DISPID_SPIRule', 'SPAS_PAUSE', 'SPBINARYGRAMMAR',
    'SRESoundStart', 'SDA_One_Trailing_Space', 'SPEI_SOUND_START',
    'DISPID_SRCEPhraseStart', 'SpSharedRecoContext',
    'SPGRAMMARWORDTYPE', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRGIsPronounceable', 'DISPID_SAEventHandle',
    'SPPS_SuppressWord', 'SPEI_TTS_PRIVATE', 'SITooFast',
    'SPPS_NotOverriden', 'ISpMMSysAudio', 'SP_VISEME_10', 'SVP_16',
    'SPWORDLIST', 'DISPID_SVSInputSentenceLength',
    'Speech_StreamPos_Asap', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRRTOffsetFromStart', 'SPSMF_UPS', 'SAFTGSM610_44kHzMono',
    'DISPID_SPIGetDisplayAttributes', 'SVEAllEvents', 'SRTReSent',
    'ISpeechGrammarRule', 'DISPID_SVEPhoneme', 'SPPS_RESERVED1',
    'SPPS_Verb', 'DISPID_SVIsUISupported', 'SGDSActive',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCRetainedAudio',
    'DISPID_SRGDictationSetState', 'DISPID_SGRSTPropertyId',
    'DISPID_SOTCategory', 'DISPID_SGRSTNextState', 'DISPID_SPEsItem',
    'DISPID_SpeechMMSysAudio', 'DISPID_SLWType', 'SPPHRASE',
    'SP_VISEME_3', 'SAFT22kHz8BitStereo', 'SRCS_Enabled',
    'SpeechGrammarTagUnlimitedDictation', 'SAFT22kHz16BitStereo',
    'SSTTTextBuffer', 'SRARoot', 'SAFT8kHz16BitStereo',
    'SPGRAMMARSTATE', 'DISPID_SPEs_NewEnum', 'UINT_PTR',
    'DISPID_SVAudioOutput', 'DISPID_SVGetProfiles', 'SPSHORTCUTPAIR',
    'SREPropertyStringChange', 'DISPID_SDKSetLongValue',
    'DISPID_SASFreeBufferSpace', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SOTCEnumerateTokens', 'SpeechTokenValueCLSID',
    'SVSFPurgeBeforeSpeak', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechPhraseProperties', 'SpObjectToken', 'IStream',
    'SP_VISEME_2', 'SPADAPTATIONRELEVANCE', 'SpeechWordPronounceable',
    'SGDisplay', 'DISPID_SGRSTText', 'ISpeechObjectToken',
    'DISPID_SPRulesItem', 'DISPID_SpeechLexiconWords', 'ISpShortcut',
    'SVP_18', 'SPSNotOverriden', 'SPWAVEFORMATTYPE',
    'SAFTADPCM_22kHzMono', 'SpPhoneConverter', 'SPPROPERTYINFO',
    'tagSTATSTG', 'SpeechCategoryRecognizers',
    'DISPID_SRGCmdLoadFromFile', 'SPFM_CREATE', 'SRCS_Disabled',
    'DISPID_SRRSaveToMemory', 'DISPID_SLPPhoneIds',
    'ISpGrammarBuilder', 'SAFTGSM610_8kHzMono',
    'ISpeechPhraseReplacements', 'DISPID_SVEWord', 'ISpRecoGrammar',
    'DISPID_SRSetPropertyString', 'SPSInterjection', 'SVP_11',
    'SREFalseRecognition', 'SpeechRecognitionType',
    'ISpeechTextSelectionInformation', 'SPPS_Modifier',
    'ISpeechGrammarRuleState', 'DISPID_SDKDeleteKey',
    'DISPID_SpeechVoice', 'DISPID_SRSetPropertyNumber',
    'SpeechRunState', 'typelib_path', 'SVP_13',
    'ISpeechXMLRecoResult', 'DISPID_SRGReset',
    ...
    'SpeechRecognizerState', 'SPSHT_OTHER', 'DISPID_SPIEngineId',
    'eLEXTYPE_USER_SHORTCUT', 'SVEWordBoundary',
    'SpeechDisplayAttributes', 'SITooLoud',
    'DISPID_SpeechLexiconPronunciation', 'SPPS_LMA',
    'DISPID_SRRTimes', 'SGSExclusive', 'SpStreamFormatConverter',
    'DISPID_SVSyncronousSpeakTimeout',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPPS_RESERVED2', 'STCAll',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSkip', 'SASStop',
    'DISPID_SpeechLexicon', 'SGRSTTWildcard', 'DISPID_SRGetFormat',
    'SpeechRuleAttributes', 'SPSModifier', 'DISPID_SVEBookmark',
    '__MIDL_IWinTypes_0009'
]

_check_version('1.4.16', 1777654917.757466)
